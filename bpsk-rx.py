...
TX_GAIN = -10.0
#URI = "ip:192.168.2.1"
URI = sdr.get_uri ( "10447318ac0f00091e002400454e18b77d" , "usb" )
print ( f"Tx {URI=}" )
...
# ------------------------ KONFIGURACJA SDR ------------------------
def main():
    pluto = sdr.init_pluto_v2 ( URI , settings["ADALM-Pluto"]["F_C"] , F_S , settings["ADALM-Pluto"]["BW"] , settings["ADALM-Pluto"]["TX_GAIN"] )
    ...
    ops_file.plot_samples ( settings["log"]["corr_and_filtered_rx_samples"] )
    ops_file.plot_samples ( settings["log"]["aligned_rx_samples"] )
