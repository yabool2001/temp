from modules import packet, ops_file, modulation, filters
import numpy as np
...
samples_filtered = filters.apply_rrc_rx_filter_v0_1_6 ( samples_noise )
...
peaks = packet.detect_sync_sequence_peaks_v0_1_15(samples_filtered, sync_sequence, deep=False)
print(f"Peaks found (deep=False): {peaks}")
print(f"Number of peaks: {len(peaks)}")

peaks_deep = packet.detect_sync_sequence_peaks_v0_1_15(samples_filtered, sync_sequence, deep=True)
