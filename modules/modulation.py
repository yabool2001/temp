...
def bits_2_bpsk_symbols_v0_1_18 ( bits : NDArray[ np.uint8 ] , sps : int | None = None ) -> NDArray[ np.complex128 ] :
    """
...
def samples_2_bpsk_symbols_v0_1_18 ( samples : NDArray[ np.complex128 ] ) -> NDArray[ np.complex128 ] :
    """
    Nie była testowana.
    Mapuje próbki RX na twarde symbole BPSK przez decyzję znaku.
